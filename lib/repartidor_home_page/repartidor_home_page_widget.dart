...
class RepartidorHomePageWidget extends StatefulWidget {
  const RepartidorHomePageWidget({super.key});

  static String routeName = 'RepartidorHomePage';
  static String routePath = '/repartidorHomePage';

  @override
  State<RepartidorHomePageWidget> createState() =>
      _RepartidorHomePageWidgetState();
}

class _RepartidorHomePageWidgetState extends State<RepartidorHomePageWidget> {
  late RepartidorHomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RepartidorHomePageModel());
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return ListView.builder(
                              ...
                              itemCount: repartidorPendientes.length,
                              itemBuilder:
                                  (context, repartidorPendientesIndex) {
                                final repartidorPendientesItem =
                                    repartidorPendientes[
                                        repartidorPendientesIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        DetalleRepartidorPageWidget.routeName,
                                        queryParameters: {
                                          'pedidoInfo': serializeParam(
                                            getJsonField(
                                              repartidorPendientesItem,
                                              r'''$''',
                                            ),
                                            ParamType.JSON,
                                          ),

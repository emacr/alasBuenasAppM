...
/// vista para supervisor estados de los pedidos
class SupervisorPedidosPageWidget extends StatefulWidget {
  const SupervisorPedidosPageWidget({super.key});

  static String routeName = 'SupervisorPedidosPage';
  static String routePath = '/supervisorPedidosPage';

  @override
  State<SupervisorPedidosPageWidget> createState() =>
      _SupervisorPedidosPageWidgetState();
}

class _SupervisorPedidosPageWidgetState
    extends State<SupervisorPedidosPageWidget> {
  late SupervisorPedidosPageModel _model;
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    height: 100.0,
                                    decoration: BoxDecoration(
                                      color: _model.estadoSeleccionado ==
                                              'eq.confirmado_sucursal'
                                          ? Color(0xFFF0A719)
                                          : Color(0xFFE0E0E0),
                                    ),
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    _model.estadoSeleccionado = 'eq.en_camino';
                                    safeSetState(() {});
                                    safeSetState(() =>
                                        _model.apiRequestCompleter = null);
                                    await _model.waitForApiRequestCompleted();
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    _model.estadoSeleccionado = 'eq.Entregado';
                                    safeSetState(() {});
                                    safeSetState(() =>
                                        _model.apiRequestCompleter = null);
                                    await _model.waitForApiRequestCompleted();

...
import 'detalle_pedido_page_model.dart';
export 'detalle_pedido_page_model.dart';

class DetallePedidoPageWidget extends StatefulWidget {
  const DetallePedidoPageWidget({
    super.key,
    this.pedidoInfo,
  });
  ...
  static String routeName = 'DetallePedidoPage';
  static String routePath = '/detallePedidoPage';

  @override
  State<DetallePedidoPageWidget> createState() =>
      _DetallePedidoPageWidgetState();
}

class _DetallePedidoPageWidgetState extends State<DetallePedidoPageWidget> {
  late DetallePedidoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetallePedidoPageModel());
  }
